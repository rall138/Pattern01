...
package pattern01.plugin.components.editors.generated;
	...
	* Creation date: Fri Jul 01 17:42:07 GFT 2016
	* Creator: rlomez
	**/
public class RelatedFilePatternEditor extends org.eclipse.ui.part.EditorPart{
	...
	public void doSave(org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		((pattern01.helpers.generated.RelatedFile)defaultEditorInput.getInstanceTree().getSelection()[0].getData("class_instance")).setName(this.getNameValue());
		((pattern01.helpers.generated.RelatedFile)defaultEditorInput.getInstanceTree().getSelection()[0].getData("class_instance")).setDescription(this.getDescriptionValue());
		((pattern01.helpers.generated.RelatedFile)defaultEditorInput.getInstanceTree().getSelection()[0].getData("class_instance")).setReference(this.getReferenceValue());
		((pattern01.helpers.generated.RelatedFile)defaultEditorInput.getInstanceTree().getSelection()[0].getData("class_instance")).setImage(this.getImageValue());
		this.dirty = false;
	}
