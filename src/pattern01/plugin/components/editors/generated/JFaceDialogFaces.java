...
public class JFaceDialogFaces extends TitleAreaDialog {
	...
	private pattern01.helpers.generated.Faces getSelectedInstance(){
		return ((pattern01.helpers.generated.Faces)this.parent.getSelection()[0].getData("class_instance"));
	}
