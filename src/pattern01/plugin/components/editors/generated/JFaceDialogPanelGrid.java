...
public class JFaceDialogPanelGrid extends TitleAreaDialog {
	
	private Tree parent = null;
	
	
	public JFaceDialogPanelGrid(Shell parentShell){
		super(parentShell);
	}
	...
	private pattern01.helpers.generated.PanelGrid getSelectedInstance(){
		return ((pattern01.helpers.generated.PanelGrid)this.parent.getSelection()[0].getData("class_instance"));
	}
