...
public class JFaceDialogPanel extends TitleAreaDialog {
	
	private Tree parent = null;
	
	
	public JFaceDialogPanel(Shell parentShell){
		super(parentShell);
	}
	...
	private pattern01.helpers.generated.Panel getSelectedInstance(){
		return ((pattern01.helpers.generated.Panel)this.parent.getSelection()[0].getData("class_instance"));
	}
	
	
	private void getPropertiesFromInstance(){
		pattern01.helpers.generated.Panel patternInstance_form_panel = getSelectedInstance();
	}
